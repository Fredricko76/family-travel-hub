...
export const demoItems: ItineraryItem[] = [
  {
    ...
    location: 'Melbourne Tullamarine, Terminal 1', notes: 'K7Q2XR · MEL → DPS · Seats 23A-D · 30 kg baggage each',
  ...
  },
  {
    ...
    location: 'DPS arrivals hall', notes: 'Driver holds a sign with the family name',
  ...
  },
  {
    ...
    location: null, notes: null, sort_order: 0, document_id: null,
  },
  {
    ...
    location: 'Tegallalang', notes: 'Driver booked · bring sunscreen', sort_order: 1, document_id: null,
  },
  {
    ...
    location: 'Jalan Raya Ubud', notes: null, sort_order: 2, document_id: null,
  },
  {
    ...
    location: 'Ubud', notes: 'Tickets ref MF-88213', sort_order: 3, document_id: null,
  },
  {
    ...
    location: 'Ubud', notes: 'Confirmation extracted from email PDF', sort_order: 4, document_id: null,
  },
  {
    ...
    location: 'Denpasar Ngurah Rai', notes: 'K7Q2XR · DPS → MEL', sort_order: 0, document_id: 'demo-doc-1',
  },
];
  ...
  items: [
    {
      ...
      location: 'Jalan Hanoman, Ubud', notes: 'Check-in from 15:00, check-out by 11:00. Airport transfer included.',
    },
    {
      ...
      location: 'Resort lobby', notes: 'Included in the booking',
    },
  ],
  confidence: 0.91,
